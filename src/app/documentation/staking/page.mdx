...
<Callout type="warning">
  After Chang hardfork, staking rewards are only withdrawable if the stake key is delegated to a DRep (Delegated Representative). For more information about DReps and governance delegation, see the [Governance documentation](https://anastasia-labs.github.io/lucid-evolution/documentation/deep-dives/governance).
</Callout>
